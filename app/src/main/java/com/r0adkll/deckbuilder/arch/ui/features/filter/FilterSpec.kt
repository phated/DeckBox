...
import com.r0adkll.deckbuilder.arch.ui.features.filter.FilterUi.FilterAttribute.ContainsAttribute
    ...
    sealed class Spec : Parcelable {
        ...
        class ExpansionSpec(
            ...
            override fun apply(filter: Filter): List<Item> {
                ...
                val attributes = listOf(ExpansionAttribute(Format.STANDARD, expansions),
